...
<body style="background-color: black"> <!-- style="background-color: black" -->
    ...
    <div class="content" style="width: 50%; margin-left: 25%; background-color: white;">
        <?php
            $id = $_REQUEST['id'];
            $query = "SELECT * FROM meteorito WHERE id='$id'";
            $envio = $conexion->query($query);
            $row=$envio->fetch_assoc();
        ?>
            <form method="POST" action="modificarMeteor.php?id=<?php echo $row['id'];?>" enctype="multipart/form-data" style=" padding: 20px; margin-top: 150px; box-shadow: 0 0 20px rgb(78, 185, 218);">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" name="nomMeteorito" class="form-control" value="<?php echo $row['nomMeteorito']; ?>">
                </div>
                <div class="form-group col-md-6">
                    <label for="inputState">Clasificación:</label>
                    <select class="form-control" name="clasificacion" value="<?php echo $row['clasificacion']; ?>">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" rows="3" name="informacion" value="<?php echo $row['informacion']; ?>"></textarea>
                </div>
                <div class="d-flex justify-content-center">
                  <input style="margin-right: 20px" type="submit" class="btn btn-outline-success" value="Modificar">
