                ...
                <div class="shadow p-3 mb-5 bg-white rounded" style="margin: 20px; margin-top: 50px;">
                    <div class="col" style="background-color: white;  width: 100%; max-width: 300px; ">
                        ...
                        <div class="card" style="width: 100%;">
                            ...
                            <div class="card-body">
                                <h5 class="card-title"> <?php echo $row['newMeteorito'] ?> </h5>
                                <dl class="row">
                                    <dt class="col-sm-4">Tipo:</dt>
                                    <dd class="col-sm-7"> <?php echo $row['tipo'] ?> </dd>

                                    <dt class="col-sm-6">Fecha Aprox:</dt>
                                    <dd class="col-sm-12"> <?php echo $row['fechaAprox'] ?> </dd>

                                    <dt class="col-sm-4">Orbita:</dt>
                                    <dd class="col-sm-8"> <?php echo $row['orbita'] ?> </dd>
                                </dl>
                                ...
                                <div class="d-flex justify-content-center">
                                    ...
                                    <a style="width: 100px;" class="btn btn-outline-danger" href="eliminarPredicciones.php?id=<?php echo $row['id']; ?>" >Eliminar</a>
                                </div>
                            </div>
                        </div>
