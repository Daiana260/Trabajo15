...
<body style="background-color: black">
    ...
    <header style="width: 100%;">
        <img src="../img/cometa" alt="" width="100%" height="350px">
                ...
                <div class="shadow p-3 mb-5 bg-white rounded" style="margin: 20px; margin-top: 50px;">
                    <div class="col" style="background-color: white;  width: 100%; max-width: 300px; ">
                        ...
                        <div class="card" style="width: 100%;">
                            <img src="data:image/jpg;base64,<?php echo base64_encode($row['foto'])?>" height="250px" class="card-img-top" alt="...">
                            <div class="card-body">
                                <h5 class="card-title"> Nombre: <?php echo $row['name'] ?> </h5>
                                <dl class="row">
                                    <dt class="col-sm-6">Apellido:</dt>
                                    <dd class="col-sm-7"> <?php echo $row['apellido'] ?> </dd>

                                    <dt class="col-sm-6">Email:</dt>
                                    <dd class="col-sm-12"> <?php echo $row['email'] ?> </dd>

                                    <dt class="col-sm-5">Telefono:</dt>
                                    <dd class="col-sm-6"> <?php echo $row['tel'] ?> </dd>
                                </dl>
                                <div class="d-flex justify-content-center">
                                    <a style="width: 100px; margin-right: 20px;" class="btn btn-outline-success" href="modificarPerfil.php?id=<?php echo $row['id']; ?>">Modificar</a>
                                    <a style="width: 100px;" class="btn btn-outline-danger" href="eliminarPerfil.php?id=<?php echo $row['id']; ?>" >Eliminar</a>
                                </div>
                            </div>
                        </div>
