...
<body style="background-image: url(../img/fodo.jpg); background-size: 100% 100%; background-attachment: fixed;">
    ...
    <div class="content" style="width: 50%; margin-left: 25%; margin-top: 100px;">
        ...
        <form action="datos.php" method="post" style="padding: 10px; background-color: rgba(255, 255, 255, 0.89);">
          <h2 style="font-family: 'Open Sans Condensed', sans-serif; font-size: 30; text-align: center;">Bienvenido Usuario</h2>
          ...
          <button type="submit" class="btn btn-outline-dark" style="width: 120px; display:block; margin-left: auto; margin-right: auto;">Iniciar Sesion</button>
        </form>
    </div>
