...
<body style="background-color: black"> <!-- style="background-color: black" -->
    ...
    <header style="width: 100%;">
        <img src="../img/fondo1.jpg" alt="" width="100%" height="300px">
    ...
    <div class="mx-auto" style="width: 90%; margin-top: 200px; background-color: white; box-shadow: 0 0 20px rgb(78, 185, 218);">
        <div class="container">
            <div class="row">
            <?php 
                ...
                <div class="shadow p-3 mb-5 bg-white rounded" style="margin: 20px; margin-top: 50px;">
                    <div class="col" style="background-color: white;  width: 100%; max-width: 300px; ">
                        ...
                        <div class="card" style="width: 100%;">
                            ...
                            <div class="card-body">
                                <h5 class="card-title"> <?php echo $row['nomSatelite'] ?> </h5>
                                <dl class="row">
                                    <dt class="col-sm-7">Tipo Mision:</dt>
                                    <dd class="col-sm-5"> <?php echo $row['mision'] ?> </dd>

                                    <dt class="col-sm-12">Mision Meteorologico:</dt>
                                    <dd class="col-sm-8"> <?php echo $row['misionMeteor'] ?> </dd>

                                    <dt class="col-sm-5">Duracion:</dt>
                                    <dd class="col-sm-5"> <?php echo $row['duracion'] ?> </dd>

                                    <dt class="col-sm-9">Fecha Lanzamiento:</dt>
                                    <dd class="col-sm-9"> <?php echo $row['fechaLanzamiento'] ?> </dd>

                                    <dt class="col-sm-4">Estado:</dt>
                                    <dd class="col-sm-6"> <?php echo $row['EstadoOperativo'] ?> </dd>

                                    <dt class="col-sm-4">Orbita</dt>
                                    <dd class="col-sm-12"> <?php echo $row['orbita'] ?> </dd>

                                    <dt class="col-sm-6">Fabricante</dt>
                                    <dd class="col-sm-12"> <?php echo $row['fabricante'] ?> </dd>
                                </dl>
                                <p class="card-text"> <?php echo $row['info'] ?> </p>
                                <div class="d-flex justify-content-center">
                                    <a style="width: 100px; margin-right: 20px;" class="btn btn-outline-success" href="editarSate.php?id=<?php echo $row['id']; ?>">Modificar</a>
                                    <a style="width: 100px;" class="btn btn-outline-danger" href="eliminarSate.php?id=<?php echo $row['id']; ?>" >Eliminar</a>
                                </div>
                            </div>
                        </div>
