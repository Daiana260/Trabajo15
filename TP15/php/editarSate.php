...
<body style="background-color: black;">
  ...
  <header style="width: 100%;">
    ...
    <div class="content" style="width: 50%; margin-left: 25%; background-color: white;">
        ...
        <?php
            $id = $_REQUEST['id'];
            $query = "SELECT * FROM satelite WHERE id='$id'";
            $envio = $conexion->query($query);
            $row=$envio->fetch_assoc();
        ?>

        <form method="POST" action="modificarSate.php?id=<?php echo $row['id'];?>" enctype="multipart/form-data" style=" padding: 20px; margin-top: 150px; box-shadow: 0 0 20px rgb(78, 185, 218);">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" name="nomSatelite" value="<?php echo $row['nomSatelite']; ?>">
            </div>
            <div class="form-group col-md-6">
                <label>Tipo de Mision:</label>
                    <select class="form-control" name="mision" value="<?php echo $row['mision']; ?>">
                    <option value="ninguna">Ninguna de Estas</option>
                    <option value="sateliteCanal">Satelite de Canal FM</option>
                    <option value="sateliteLineal">Satelite Transportador Lineal</option>
                    <option value="sateliteDigital">Satelite de modos Digital</option>
                    <option value="(ISS)">Estación Espacial Internacional</option>
            ...
            <div class="form-row">
              <div class="form-group col-md-6">
                <label>Tipo de Mision Meteorologico:</label>
                    <select class="form-control" name="misionMeteor" value="<?php echo $row['misionMeteor']; ?>">
                    <option value="ninguna">Ninguna de Estas</option>
                    <option value="satelitePolar">Satelite Polares</option>
                    <option value="sateliteGeoestacionarios">Satélites Geoestacionarios</option>
                </select>
              </div>
                <div class="form-group col-md-6">
                    <label>Fabricante:</label>
                    <input type="text" class="form-control" name="fabricante" value="<?php echo $row['fabricante']; ?>">
                </div>
            </div>
            ...
            <div class="form-row">
              <div class="form-group col-md-6">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="datetime-local" class="form-control" name="fechaLanzamiento" value="<?php echo $row['fechaLanzamiento']; ?>">
                </div>
            </div>
            ...
            <div class="form-row">
              <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" name="EstadoOperativo" value="<?php echo $row['EstadoOperativo']; ?>">
              </div>
                <div class="form-group col-md-6">
                    <label>Orbita:</label>
                    <input type="text" class="form-control" name="orbita" value="<?php echo $row['orbita']; ?>">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" rows="3" name="info" value="<?php echo $row['info']; ?>"></textarea>
            </div>
            <div class="d-flex justify-content-center">
